...
<%@include file ="../includes/header.jsp" %>
	...
	<div class="login-body">
		<div class="login-form">
			<form action="mypage.do" method="post" name="mypage">
				<p class="labeled">아이디</p>
				<input type="text" name="id" id="id" class="text-field" readonly="readonly" value='<c:out value="${member.id }"></c:out>'><br>
				<p class="labeled">성함</p>
				<input type="text" name="name" id="name" class="text-field" readonly="readonly" value='<c:out value="${member.name }"></c:out>'><br>
				<p class="labeled">이메일</p>
				<input type="text" name="email" id="email" class="text-field" readonly="readonly" value='<c:out value="${member.email }"></c:out>'><br>
				<p class="labeled">전화번호</p>
				<input type="text" name="phone" id="phone" class="text-field" readonly="readonly" value='<c:out value="${member.phone }"></c:out>'><br>
				<p class="labeled">가입날짜</p>
				<input type="text" name="join_date_pr" id="join_date_pr" class="text-field" readonly="readonly" value='<fmt:formatDate value="${member.join_date }" pattern="yyyy-MM-dd"/>'><br>
