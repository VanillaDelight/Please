...
<body>
	...
	<div class="slide_div_wrap">
            <div class="slide_div">
               <div>
                  <a>
                     <img style="width: 800px; height: 300px;" src="${pagaContext.request.contextPath}/resources/assets/img/bg-showcase-2.jpg" />
                  </a>
               </div>
               <div>
                  <a>
                     <img style="width: 800px; height: 300px;" src="${pagaContext.request.contextPath}/resources/assets/img/bg-showcase-3.jpg" />
                  </a>
               </div>      
            </div>   
         </div>
	...
	<!-- Core theme JS-->
	<script src="${pagaContext.request.contextPath}/resources/js/scripts.js"></script>
	<!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
	<!-- * *                               SB Forms JS                               * *-->
